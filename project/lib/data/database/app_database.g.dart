...
class $CategoriesTable extends Categories
  ...
  late final GeneratedColumn<String> icon = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('fork_knife'),
  );
...
class $RestaurantTablesTable extends RestaurantTables
  ...
  RestaurantTable map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RestaurantTable(
      ...
      status: $RestaurantTablesTable.$converterstatus.fromSql(
  ...
  static JsonTypeConverter2<TableStatus, int, int> $converterstatus =
...
class RestaurantTable extends DataClass implements Insertable<RestaurantTable> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['display_order'] = Variable<int>(displayOrder);
    {
      map['status'] = Variable<int>(
        $RestaurantTablesTable.$converterstatus.toSql(status),
      );
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
  ...
  factory RestaurantTable.fromJson(
    ...
    return RestaurantTable(
      ...
      displayOrder: serializer.fromJson<int>(json['displayOrder']),
      status: $RestaurantTablesTable.$converterstatus.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'status': serializer.toJson<int>(
        $RestaurantTablesTable.$converterstatus.toJson(status),
      ),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
...
class RestaurantTablesCompanion extends UpdateCompanion<RestaurantTable> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (status.present) {
      map['status'] = Variable<int>(
        $RestaurantTablesTable.$converterstatus.toSql(status.value),
      );
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
...
class $OrdersTable extends Orders with TableInfo<$OrdersTable, Order> {
  ...
  Order map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Order(
      ...
      paymentStatus: $OrdersTable.$converterpaymentStatus.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class Order extends DataClass implements Insertable<Order> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_closed'] = Variable<bool>(isClosed);
    {
      map['payment_status'] = Variable<int>(
        $OrdersTable.$converterpaymentStatus.toSql(paymentStatus),
      );
    }
    map['created_at'] = Variable<DateTime>(createdAt);
  ...
  factory Order.fromJson(
    ...
    return Order(
      ...
      paymentStatus: $OrdersTable.$converterpaymentStatus.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'paymentStatus': serializer.toJson<int>(
        $OrdersTable.$converterpaymentStatus.toJson(paymentStatus),
      ),
      'createdAt': serializer.toJson<DateTime>(createdAt),
...
class OrdersCompanion extends UpdateCompanion<Order> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (paymentStatus.present) {
      map['payment_status'] = Variable<int>(
        $OrdersTable.$converterpaymentStatus.toSql(paymentStatus.value),
      );
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
...
class $OrderItemsTable extends OrderItems
  ...
  @override
  late final GeneratedColumnWithTypeConverter<OrderItemStatus, int> status =
      GeneratedColumn<int>(
        'status',
        aliasedName,
        false,
  ...
  static JsonTypeConverter2<OrderItemStatus, int, int> $converterstatus =
      const EnumIndexConverter<OrderItemStatus>(OrderItemStatus.values);
}
...
class OrderItemsCompanion extends UpdateCompanion<OrderItem> {
  ...
  final Value<String?> note;
  final Value<OrderItemStatus> status;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
...
final class $$RestaurantTablesTableReferences
  ...
  static MultiTypedResultKey<$OrdersTable, List<Order>> _ordersRefsTable(
    ...
    db.orders,
    aliasName: 'restaurant_tables__id__orders__table_id',
  );
...
class $$RestaurantTablesTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<TableStatus, TableStatus, int> get status =>
      $composableBuilder(
        column: $table.status,
...
class $$RestaurantTablesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<TableStatus, int> get status =>
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> displayOrder = const Value.absent(),
                Value<TableStatus> status = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
                Value<DateTime> updatedAt = const Value.absent(),
...
final class $$OrdersTableReferences
  ...
  static $RestaurantTablesTable _tableIdTable(_$AppDatabase db) => db
      .restaurantTables
      .createAlias('orders__table_id__restaurant_tables__id');
...
class $$OrderItemsTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<OrderItemStatus, OrderItemStatus, int>
...
class $$OrderItemsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<OrderItemStatus, int> get status =>
      $composableBuilder(column: $table.status, builder: (column) => column);
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> note = const Value.absent(),
                Value<OrderItemStatus> status = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
                Value<DateTime> updatedAt = const Value.absent(),
              }) => OrderItemsCompanion(
                id: id,
